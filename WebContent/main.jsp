...
String redirecthead = "http://localhost:8082" + contextPath123 + "/css/header_style.css";

String redirectmain = "http://localhost:8082" + contextPath123 + "/css/main.css";

String redirectfoot = "http://localhost:8082" + contextPath123 + "/css/footer.css";

String redirectjquery = "http://localhost:8082" + contextPath123 + "/js/jquery-3.7.0.min.js";

String redirectjseat = "http://localhost:8082" + contextPath123 + "/js/seat_script.js";
%> 
