...
String redirectmain= "http://localhost:8082" + contextPath123 + "/index.jsp";
...
String redirectcss = "http://localhost:8082" + contextPath123 + "/admin/admin.css";
String redirectout = "http://localhost:8082" + contextPath123 + "/logout.do";
String redirectmgl= "http://localhost:8082" + contextPath123 + "/admin/adminMovie/MovieGetAll.do";
String redirectbor= "http://localhost:8082" + contextPath123 + "/userboard/getAdminBoard.do";
String redirectadminbor= "http://localhost:8082" + contextPath123 + "/admin/adminBoard/getAdminOnlyBoard.do";
String redirectadminbook= "http://localhost:8082" + contextPath123 + "/admin/adminBook/getAllBook.do";
String redirectadminMovieSearch= "http://localhost:8082" + contextPath123 + "/admin/adminMovie/MovieSearch.do";
String redirectadmingetTh= "http://localhost:8082" + contextPath123 + "/admin/getTheater.do";
String redirectadminThGetAll= "http://localhost:8082" + contextPath123 + "/admin/adminTheater/TheaterGetAll.do";
String redirectadminThInsert= "http://localhost:8082" + contextPath123 + "/admin/adminTheater/theInsertForm.jsp";
String redirectadminScgetAll= "http://localhost:8082" + contextPath123 + "/admin/adminScreen/ScreenGetAll.do";
String redirectadminScInsert= "http://localhost:8082" + contextPath123 + "/admin/adminScreen/ScreenInsertForm.jsp";
String redirectadminSt= "http://localhost:8082" + contextPath123 + "/admin/adminStime/getStime.do";
String redirectadminStInsert= "http://localhost:8082" + contextPath123 + "/admin/adminStime/stimeInsertForm.jsp";
String redirectadmingetMem= "http://localhost:8082" + contextPath123 + "/admin/adminMember/getMember.do";
%> 
