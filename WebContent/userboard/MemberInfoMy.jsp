...
<br><br>
	...
	<div class="df">
		...
		<br>
			&nbsp;&nbsp;&nbsp;
  			<input type="text" name="pw1" placeholder="비밀번호를 입력해주세요."><br>
  				<div style="color:red;">
  				&nbsp;&nbsp;&nbsp;&nbsp;8~15자리의 영문/숫자/특수문자를 함께 입력해주세요.<br><br>
  				</div>
  			&nbsp;&nbsp;&nbsp;
  			<input type="text" name="pw2" placeholder="입력하신 비밀번호를 다시한번 입력해주세요."><br>
		</div><br><hr><br>
	...
	<div style="color:red;">*&nbsp;</div>
	이메일 주소&nbsp;&nbsp;&nbsp;
	<input type=text name="emil" value="${mv.m_email}"><br>
	</div><br><hr><br>	
